...
\textbf{Preconditions} & 
1. Hệ thống Quản lý Bãi đỗ xe Thông minh cho Khuôn viên Trường Đại học đang hoạt động. \newline
...
6. Hệ thống gửi lệnh đến servor motor controller của barrier để mở cổng. \newline
7. Cảm biến nhận diện chuyển động của phương tiện qua barrier. \newline
8. Hệ thống gửi lệnh đến servor motor controller của barrier để đóng cổng sau khi cảm biến nhận diện phương tiện đã qua cổng. \\ \hline
\end{tabular}
\end{adjustbox}
